...
public class WorldToolsFileWriter {
	...
	public void writeWorldProperties(File f, String world){
		try {
			...
			out.write("#====WorldTools settings file, for world "+world+"====#"); out.newLine();
			out.write("#=====================================================#"); out.newLine();
			out.write(" "); out.newLine();
	 ...
	 * @param file
	 */
	public void writeGlobalProperties(File f){
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(f));
			out.write("#=====================================================#");                out.newLine();
			out.write("#==========WorldTools global properties file==========#");                out.newLine();
			out.write("#=============Capital matter at variables=============#");                out.newLine();
			out.write("#=====================================================#");                out.newLine();
			out.newLine();
			out.write("#Specify your default world name (mind capitals)");                       out.newLine();
			out.write("Default-world-name=world");                                               out.newLine();
			out.newLine();
			out.write("#use individual homes for each world (else we use default world homes)"); out.newLine();
			out.write("Use-individual-homes=false");                                             out.newLine();  
			out.newLine();
			out.write("#use individual kits for each world (else we use default world kits)");   out.newLine();
			out.write("Use-individual-homes=false");                                             out.newLine();  
			out.newLine();
			out.write("#Allow warping between worlds");                                          out.newLine();
			out.write("Allow-world-warping=true");                                               out.newLine();
			out.close();
		}catch (IOException e){
			log.log(Level.SEVERE,"[WorldTools] - Couldn't Create Settings File!");
		}
	...
	public void writeCommands(File f) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(f));
			out.write("#=====================================================#");out.newLine();
			out.write("#===========WorldTools global commands file===========#");out.newLine();
			out.write("#=====================================================#");out.newLine();
			out.newLine();
			out.close();
		}catch (IOException e){
	 ...
	 * @param f
	 */
	public void writeMysql(File f){
    if (!f.exists()) {
	      try {
			BufferedWriter out = new BufferedWriter(new FileWriter(f));
			out.write("#=====================================================#");out.newLine();
			out.write("#===========WorldTools MySQL Properties file==========#");out.newLine();
			out.write("#=====================================================#");out.newLine();
	        out.newLine();
	        out.write("#Use MySQL");
	        out.write("MySQL=false");out.newLine();
	        out.newLine();
